  ...
  return (
    <div className="client-shell">
      ...
      <form className="client-form" onSubmit={handleSubmit}>
        <label>
          Nombre completo
          <input name="name" value={formData.name} onChange={handleChange} required placeholder="Ej. María Pérez" />
        </label>
        <label>
          Correo electrónico
          <input type="email" name="email" value={formData.email} onChange={handleChange} required placeholder="Ej. maria@ejemplo.com" />
        </label>
        <label>
          Teléfono
